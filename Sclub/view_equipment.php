...
if (isset($_POST['borrow_id'])) {
    if ($borrowed_items < 3) {
        ...
        $_SESSION['confirmation_message'] = "Borrow limit reached! You can only have 3 items at a time.";
    }
}
?>
...
<div class="container">
    ...
    <p>You have currently borrowed <strong><?php echo $borrowed_items; ?></strong> out of 3 allowed items.</p>
            ...
            <tr>
                ...
                <td>
                    <form method="POST">
                        ...
                        <button type="submit" <?php echo ($borrowed_items >= 3) ? 'disabled' : ''; ?>>Borrow</button>
                    </form>
                </td>
            </tr>
        <?php } ?>
